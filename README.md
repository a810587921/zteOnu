...
- The interface MAC must be one the device accepts. Historically the device accepted `00:07:29:55:35:57`; spoof the
  interface MAC (or use a device that accepts the current MAC) so the payload matches what the device expects.
